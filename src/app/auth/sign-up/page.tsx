...
function mapSignUpErrorMessage(error: unknown): string {
  ...
  if (
    ...
    return "Too many confirmation email requests. Please wait a few minutes, then try again. If you already signed up, use Login or Forgot Password.";
  }
          ...
          <form className="space-y-4" onSubmit={handleSignUp}>
            ...
            <label className="block space-y-2">
              ...
              <select
                ...
                className="w-full rounded-lg bg-[#e4eafc] px-4 py-3 text-base font-medium text-[#1f2637] outline-none ring-[#0c49a6] transition focus:ring-2"
              >
                <option value="user">User</option>
                <option value="admin">Admin</option>
              </select>
              <p className="text-xs font-medium text-[#6a7182]">
